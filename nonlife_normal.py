...
DMU=['A', 'B', 'C', 'D', 'E']
#%%
X1 = make_dict(par=[[1], [1], [1], [1], [1000000]])
# X2 = make_dict(par=[[4], [6], [8], [10], [12]])
X2_1 = make_dict(par=[[2], [2], [2], [20], [4000000]])
...
for k in DMU:
    ...
    for j in DMU:
        ...
        P1[j] = m.addConstr(w[0] * Z1[k] - (v[0] * X1[k] + v[1] * X2_1[k]) <= 0)
...
#%%
x = np.array([[1, 2], [1, 2], [1, 2], [1, 20], [1000000, 4000000]])
