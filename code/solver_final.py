...
def solve(df, DMU, NAME="temp"):
    ...
    #         return THRESHOLD
    #     return val
    RESULT_COL = ["eff_total", "eff_p1", "eff_p2", "eff_p3", "eff_s1", "eff_s2", "eff_s3", "ineff_p1", "ineff_p2", "ineff_p3"]
    ...
    E={}
    val_p1,val_p2,val_p3,val_s1,val_s3, val_s2={},{},{},{},{},{}
    ...
    for k in DMU:
        ...
        for j in DMU:
            ...
            # m.addConstr(w[2] * Z2to3[j] >= THRESHOLD)
    ...
    for k in DMU:
        result_CRS = result_CRS.append(pd.DataFrame(data=[[E[k], val_p1[k], val_p2[k], val_p3[k], val_s1[k], val_s2[k], val_s3[k], slack_p1[k], slack_p2[k], slack_p3[k]]], columns=RESULT_COL, index=[k]))
    ...
    #######################
    E={}
    val_p1,val_p2,val_p3,val_s1, val_s2,val_s3={},{},{},{},{}, {}
    slack_p1,slack_p2,slack_p3={},{},{}
    I = 2
    O = 2
    MID = 3
    ...
    for k in DMU:
        ...
        for j in DMU:
            ...
            # m.addConstr(w[2] * Z2TO3[j] - w_0[1] >= THRESHOLD)
    ...
    for k in DMU:
        result_VRS = result_VRS.append(pd.DataFrame(data=[[E[k], val_p1[k], val_p2[k], val_p3[k], val_s1[k], val_s2[k], val_s3[k], slack_p1[k], slack_p2[k], slack_p3[k]]], columns=RESULT_COL, index=[k]))
    ...
    with pd.ExcelWriter('/Users/tungwu/Documents/GitHub/ORA_final_project/result/final_result/%s_result.xlsx' % NAME) as writer:  
        data.to_excel(writer, sheet_name="data") 
